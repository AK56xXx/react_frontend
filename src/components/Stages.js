...
import { addNewStageApi } from "../redux/actions/stages.actions";
const AddStages = ({ show, close, dateEvent }) => {
  ...
  const onSubmit = (data) => {
    ...
    formData.append("institut", data.institut);
    formData.append("lettre_motivation", data.lettre_motivation[0]);
    formData.append("cv", data.lettre_motivation[0]);
  ...
  const confirmAppointment = () => {
    ...
    addToast("Votre demande à été envoyé", {
      appearance: "success",
      autoDismiss: true,
    });
    close();
                    ...
                    <div class="w-full space-y-6">
                      ...
                      <div class="w-full">
                        <div class=" relative ">
                          ...
                          <br />
                          <select
                            {...register("type_stage", { required: true })}
                            id="type"
